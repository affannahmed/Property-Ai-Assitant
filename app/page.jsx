...
// // API client
// const apiClient = axios.create({
//   baseURL: "https://b9371f46dd1b.ngrok-free.app",
//   timeout: 120000,
//   headers: {
//     "Content-Type": "application/json",
...
//         user: "frontend-user", // you can pass actual user identifier if needed
//         question: input,
//       })
...
//         content = `🖼️ Image generated: ${data.url}`
...
//       toast({
//         variant: "destructive",
//         description: "Error contacting server. Please try again.",
//         duration: 3000,
//       })
//     } finally {
//       setIsLoading(false)
...
//                   )}
//                 >
//                   {message.role === "user" ? <User className="h-5 w-5" /> : <Scale className="h-5 w-5" />}
//                 </div>
//                 {editingMessageId === message.id ? (
//                   <div className="flex-1 flex flex-col gap-2">
//                     <div className="flex-1">
...
//                       <Button size="sm" onClick={() => handleSaveEdit(message.id)} disabled={!editedMessageContent.trim()}>
//                         Save
//                       </Button>
//                     </div>
//                   </div>
...
//         {/* Input area */}
//         <div className="border-t py-4">
//           <form onSubmit={handleSubmit} className="flex flex-col md:flex-row items-center gap-4 max-w-md mx-auto w-full px-4">
//             <div className="flex items-center gap-2 w-full">
//               <Input
//                 value={input}
//                 onChange={handleInputChange}
...
export default function PropertyAssistant() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await apiClient.post("/ask", {
        question: input,
        user: "user1", // Replace with actual user ID if needed
      })
...
<p className="text-muted-foreground max-w-2xl mb-8 mt-8">
  ...
  Tell us your requirements, and we’ll guide you toward the best opportunities.
</p>
